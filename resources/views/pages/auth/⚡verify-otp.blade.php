...
<div class="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12">
    ...
    <div class="w-full max-w-md rounded-lg bg-white p-8 shadow-sm ring-1 ring-gray-200">
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">Enter the 6-digit code we sent to <span class="font-medium text-gray-900">{{ $email }}</span>.</p>
        </div>
        ...
        <p class="mt-6 text-center text-sm text-gray-600">
            Didn't get it? <button type="button" wire:click="resend" class="font-medium text-indigo-600 hover:text-indigo-500">Resend code</button>
        </p>
    </div>
</div>
